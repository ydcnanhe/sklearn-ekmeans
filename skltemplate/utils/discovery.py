"""
The :mod:`sklekmeans.utils.discovery` module includes utilities to discover
objects (i.e. estimators, displays, functions) from the `sklekmeans` package.
"""
