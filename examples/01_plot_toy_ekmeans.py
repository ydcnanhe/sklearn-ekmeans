...
This example mirrors scikit-learn's "Comparing different clustering
algorithms on toy datasets" in layout and visuals, and extends it with
`EKMeans <https://ydcnanhe.github.io/sklearn-ekmeans/>`_.

Datasets
--------
- ``noisy_circles``
- ``noisy_moons``
- ``varied`` (different cluster std)
- ``aniso`` (anisotropic blobs)
